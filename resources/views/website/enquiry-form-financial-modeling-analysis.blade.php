                            ...
                            <form action="{{url('nomanform')}}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control selectpicker" name="coursesintrested" id="coursesintrested"
                                                multiple
                                                aria-label="Default select example" data-live-search="true"
                                                placeholder="Choose from dropdown list">
                                            <option selected value="Financial Modeling and Analysis">Financial Modeling and
                                                Analysis
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="row pl-4">
                                    <div class="col-lg-2" style="margin:0px 20px">
                                        <button type="submit" class="btn btn-lmslogin1">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>

...
<style>
    ...
    h3 {
        ...
        color: rgba(196, 21, 28, 1);
                ...
                <div class="jsformWrapper" style="display: none">
                         <form name="jsform" method="post" action="https://sandbox.jazzcash.com.pk/CustomerPortal/transactionmanagement/merchantform/">
                            ...
                            <div class="formFielWrapper">
                                ...
                                <input type="text" name="pp_TxnRefNo" id="pp_TxnRefNo" value="{{rand(1,1000)}}">
                            </div>

                            <div class="formFielWrapper">
                                <label class="active">pp_Amount: </label>
                                <input type="text" name="pp_Amount" value="500">
                            </div>
                            ...
                            <div class="formFielWrapper">
                                ...
                                <input type="text" name="pp_TxnDateTime" id="pp_TxnDateTime" value="20221129165942">
                            </div>

                            <div class="formFielWrapper">
                                <label class="active">pp_TxnExpiryDateTime: </label>
                                <input type="text" name="pp_TxnExpiryDateTime" id="pp_TxnExpiryDateTime" value="20221129165942">
                            </div>
                            ...
                            <div class="formFielWrapper">
                                ...
                                <input type="text" name="pp_ReturnURL" value="https://youexceltraining.com/payment_success">
                            </div>

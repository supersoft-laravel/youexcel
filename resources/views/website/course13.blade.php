...
@section('content')
            ...
            <div class="row flex-row-reverse">
                <div class="col-lg-4">
                    <div class="course-meta-box wow fadeInUp ">
                        ...
                        @endif
                        <a href="https://youexceltraining.com/enquiry-form/presenting-with-impact-workshop"
                ...
                <div class="col-lg-8">
                    ...
                    <p class="wow fadeInDown pb-3">Presenting is almost a necessity in many job roles today and the ability
                        to present with an impact is critical. A presenter has a message to deliver and wants to get the
                        maximum effect with minimum effort. In addition to highlighting the fundamental principles of
                        successful presenting, this course enables you to use powerful delivery methods to effectively
            ...
            <div class="row gy-3">
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                        ...
                        <p class="mb-0" style="font-size: 15px; color: #333;">
                            What are the steps to take when preparing presentation
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                        ...
                        <p class="mb-0" style="font-size: 15px; color: #333;">
                            How to set the structure of presentation
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                        ...
                        <p class="mb-0" style="font-size: 15px; color: #333;">
                            Mastering delivery of presentation tips and techniques to create high
                            impact
                        </p>
                    </div>
                </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card h-100 text-center shadow-sm border-0"
                        ...
                        <h6 style="font-weight: 600; color: #212529;">Effective Engagement Techniques</h6>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card h-100 text-center shadow-sm border-0"
                        ...
                        <img src="https://youexceltraining.com/img/icon/training-icon-1-2.svg" alt="icon"
                            style="width: 60px; margin-bottom: 20px;">
                        <h6 style="font-weight: 600; color: #212529;">Thorough Preparation Process</h6>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card h-100 text-center shadow-sm border-0"
                        ...
                        <img src="https://youexceltraining.com/img/icon/training-icon-1-3.svg" alt="icon"
                            style="width: 60px; margin-bottom: 20px;">
                        <h6 style="font-weight: 600; color: #212529;">Structured Content Delivery</h6>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="card h-100 text-center shadow-sm border-0"
                        ...
                        <img src="https://youexceltraining.com/img/icon/training-icon-1-4.svg" alt="icon"
                            style="width: 60px; margin-bottom: 20px;">
                        <h6 style="font-weight: 600; color: #212529;">Confident Delivery Techniques</h6>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="card h-100 text-center shadow-sm border-0"
                        ...
                        <img src="https://youexceltraining.com/img/icon/training-icon-1-5.svg" alt="icon"
                            style="width: 60px; margin-bottom: 20px;">
                        <h6 style="font-weight: 600; color: #212529;">Optimizing the Presentation Environment</h6>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 border-0 shadow-sm text-start p-3"
                        ...
                        <p style="font-size:14px; color:#333; margin:0;">
                            Sales, IT Professionals, Data Analysts, Business Analysts, Marketing Professionals, Project
    ...
    <section class="py-5 m-3 cta-style2">
        <div class="container text-center">
            ...
            <!-- CTA Button -->
            <a href="../Registration-Form/presenting-with-impact-workshop" class="btn btn-lg fw-bold"

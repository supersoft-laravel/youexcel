        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <p>New BBSHRRDB Enquiry Form Submission</p>
                    <p>
                        <div class="info"><strong>Name:</strong> {{ $email_data['name'] }}</div>
                        <div class="info"><strong>Email:</strong> {{ $email_data['email'] }}</div>
                        <div class="info"><strong>Phone:</strong> {{ $email_data['contact_no'] }}</div>
                        <div class="info"><strong>Whatsapp:</strong> {{ $email_data['whatsapp_no'] }}</div>
                        <div class="info"><strong>Last Education:</strong> {{ $email_data['last_education'] }}</div>
                        <div class="info"><strong>City:</strong> {{ $email_data['city'] }}</div>
                        <div class="info"><strong>Age:</strong> {{ $email_data['age'] }}</div>

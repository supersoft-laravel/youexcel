                            ...
                            <div class="card">
                                ...
                                <div id="" class="collapse show" aria-labelledby="headingThree">
                                    <div class="card-body">
                                        ...
                                        that is in consonance with the technological requirements of the employer organization. Moreover, 
                                        YouExcel’s mission is to enhance retainability and skill upgradation of the existing employees of 
                                        an organization by addressing and responding to the changing skills landscape in real time among 
                                        fresh graduates and mid-level professionals thereby contributing towards the welfare of the economy,
                                        employer and employee. We pursue a non-discriminatory policy for the purpose of admission to our 
                                        training programs. The only condition is competence and academic/experience yardstick for each program
                                        individually. We are affiliated with National Vocational and Technical Training Centre (NAVTTC), Sindh
                                        Technical Education & Vocational Training Authority (STEVTA) and Trade Testing Board (TTB).  
                                        </p>
                                    </div>
...
WhatsApp: +92 331 3016699
                                    ...
                                    <p  style="margin:15px!important">
                                        NAVTTC / Kamyab Jawan Program:
                                        <ul>
                                            <li>1-Digital Marketing</li>
                                            <li>2-Office Management</li>
                                            <li>3-Computerized Accounting</li>
                                            <li>4-Customer Service & Sales Representative</li>
                                        </ul>

                                    <br/>
                                    <p style="margin:15px!important">For Registeration <a href="https://www.youexceltraining.com/Kamyab-Jawan-Form">Click here</a></p>
                                    </p>
                                    ...
                                    <p  style="margin:15px!important">
                                      ...
                                      <ul>
                                            <li>1-	Financial Modeling & Analysis</li>
                                            <li>2-	Dashboard Reporting & Analysis with Power BI</li>
                                            <li>3-	Advance MS Excel- (Business Intelligence With Data Visualization)</li>
                                            <li>4-	Computerized Accounting-(Peach Tree; Quick Book)</li>
                                            <li>5-	Data Science with BI Reporting</li>
                                            <li>6-	Introduction to Python Programming (Basic to Intermediate)</li>
                                            <li>7-	Tax Management with Returns Filing</li>
                                        </ul>
                                        
                                        <p   style="margin:15px!important">
                                            For Registeration Click here: https://www.youexceltraining.com/Registration-Form
                                        </p>
                                    </p>
...
YouExcel is not responsible for any losses; please do not leave your belongings unattended.
                                    ...
                                    <p  style="margin:15px!important">
                                     ...
                                     <p  style="margin:15px!important">
                                         ...
                                         <p  style="margin:15px!important">Approved by CEO: August 2022</p>
 <p  style="margin:15px!important">
     (Farhan Shahid Qazi)
CEO YouExcel
 </p>

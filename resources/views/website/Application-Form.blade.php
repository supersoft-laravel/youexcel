                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select required class="selectpicker" name="course_first"
                                                            ...
                                                            <option value="Certificate in Office Management">Certificate
                                                                in
                                                                Office Management
                                                            </option>
                                                            <option value="Amazon Virtual Assistant">Amazon Virtual Assistant</option>
                                                             <option value="E-Commerce">E-Commerce</option>
                                                              <option value="Graphic Design (UI/UX Designer)">Graphic Design (UI/UX Designer)</option>
                                                               <option value="Graphic Design and Video Editing">Graphic Design and Video Editing</option>
                                                                <option value="Artificial Intelligence (Machine Learning, Deep Leaning, Communication)">Artificial Intelligence (Machine Learning, Deep Leaning, Communication)</option>
                                                                 <option value="Data Mining / Business Intelligence">Data Mining / Business Intelligence</option>
                                                                 
                                                                 <option value="Certificate in IT (Web Development)">Certificate in IT (Web Development)</option>
                                                        </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="form-checkbox">
                                                        ...
                                                        <label for="Morning">
                                                            <input value="Morning: 8:30 am to 1:30 pm" type="radio"
                                                                   id="Morning"
                                                                   name="class_timing">
                                                            <span></span>Morning:8:30 am to 1:30 pm
                                                        </label>

                                                        <label for="Afternoon">
                                                            <input value="Afternoon: 1:30 pm to 5:30pm" type="radio"
                                                                   id="Afternoon"
                                                                   name="class_timing">
                                                            <span></span>Afternoon: 1:30 pm to 5:30pm
                                                        </label>
                                                         <label for="Evening">
                                                            <input value="Evening: 4:30 pm to 9:30 pm" type="radio"
                                                                   id="Evening"
                                                                   name="class_timing">
                                                            <span></span>Evening: 4:30 pm to 9:30 pm
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>

...
@section('meta_description',
    'Enroll in the Dashboard Reporting & Analysis with Power BI Course in Karachi. Learn to
                ...
                <div class="col-lg-8">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="overview">
                            ...
                            <p class="mb-2">
                                Gain practical expertise in developing dynamic dashboards and data-driven reports using MS
                                Excel and Power BI. This program equips participants to clean, transform, and model data,
                                apply DAX for powerful analytics, and present insights through AI-enhanced visualization and
                                reporting tools. Equip yourself with the tools top analysts use to deliver real business
                                insights that impact decision making process of the organization.
                            </p>
                        </div>
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                                            ...
                                            <p class="mb-0" style="font-size: 15px; color: #333;">
                                                Apply Time Intelligence and advanced analytics for trend and performance
                                                analysis.
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-12 mb-4">
                                            <div class="trainer-card">
                                                ...
                                                <div class="profile-header row">
                                                    <p class="col-md-8">
                                                        <b>Tahir Ali</b> is a Master’s degree holder, Microsoft Certified
                                                        Trainer, and holds the Microsoft Power BI Data Analyst (PL-300)
                                                        Certification, enabling him to deliver industry-aligned,
                                                        business-focused analytics and BI training.
                                                    </p>
                                                    <div class="trainer-image-wrapper col-md-4">
                                                        <img src="{{ asset('img/trainer/new2/Tahir-Ali-Dashboard-Reporting-and-Analysis-with-Excel-Power-BI.png') }}"
                                                            alt="Trainer Image">
                                                ...
                                                <p>
                                                    With over 16 years of professional experience, he is a highly motivated
                                                    corporate trainer who has designed and delivered impactful training
                                                    programs across diverse industries. He has successfully trained both
                                                    small and large groups, specializing in professional learning
                                                    methodologies and instructional design while integrating modern
                                                    instructional technologies for both onsite and virtual training
                                                    sessions. His approach is practical, outcome-driven, and aligned with
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-12">
                                            <div class="d-flex align-items-start p-3 bg-white rounded shadow-sm h-100"
                                                ...
                                                <p class="mb-0" style="font-size: 15px; color: #444;">
                                                    Certificate of completion recognized from the Trade Testing Board,
                                        ...
                                        <div class="col-md-12">
                                            <div class="d-flex align-items-start p-3 bg-white rounded shadow-sm h-100"
                                                ...
                                                <p class="mb-0" style="font-size: 15px; color: #444;">
                                                    Fully equipped training center venue for on-campus sessions, with
                                                    laptops, projectors, and air-conditioning.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="card h-100 border-0 shadow-sm text-start p-3"
                                                ...
                                                <p style="font-size:14px; color:#333; margin:0;">
                                                    Data Analysts, Business Intelligence Professionals, IT Experts,
                                                    Managers, Developers, Finance Professionals, Project Managers.
                                                </p>
                                            </div>
                                        </div>

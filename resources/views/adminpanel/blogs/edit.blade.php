                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror"
                                placeholder="Enter slug" value="{{ old('slug', $blog->slug) }}" required>
                            @error('slug') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <!--            <option value="{{ $course->id }}" {{ old('course_id', $blog->course_id) == $course->id ? 'selected' : '' }}>-->
                        <!--                {{ $course->coursename }}-->
                        <!--            </option>-->
                        <!--        @endforeach-->
                        <!--    </select>-->
                        ...
                        <div class="form-group">
                            ...
                            @enderror
                            @if($blog->main_image)
                                <img src="{{ asset($blog->main_image) }}" height="50px" class="m-3">
                            @endif
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" rows="5"
                                ...
                                placeholder="Enter content" id="content">{{ old('content', $blog->content) }}</textarea>
                            @error('content') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="meta_title" id="meta_title" class="form-control @error('meta_title') is-invalid @enderror"
                                placeholder="Enter meta title" value="{{ old('meta_title', $blog->meta_title) }}">
                            @error('meta_title') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="meta_description" id="meta_description" class="form-control @error('meta_description') is-invalid @enderror"
                                placeholder="Enter meta title" value="{{ old('meta_description', $blog->meta_description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="meta_keywords" id="meta_keywords" class="form-control @error('meta_keywords') is-invalid @enderror"
                                placeholder="Enter meta title" value="{{ old('meta_keywords', $blog->meta_keywords) }}">
                            @error('meta_keywords') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_footer_switch" name="is_footer" value="1" {{ old('is_footer', $blog->is_footer) == '1' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="is_footer_switch">Enable Footer Section</label>
                            </div>
                        </div>
                        
                        <div id="footer_fields"  style="{{ (old('is_footer', $blog->is_footer) == '1') ? 'display: block;' : 'display: none;' }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="footer_title" id="footer_title" class="form-control @error('footer_title') is-invalid @enderror"
                                    placeholder="Enter footer title" value="{{ old('footer_title', $blog->footer_title) }}">
                                @error('footer_title') 
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="footer_description" id="footer_description" rows="3" 
                                    ...
                                    placeholder="Enter footer description">{{ old('footer_description', $blog->footer_description) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="footer_btn_txt" id="footer_btn_txt" class="form-control @error('footer_btn_txt') is-invalid @enderror"
                                    placeholder="Enter button text" value="{{ old('footer_btn_txt', $blog->footer_btn_txt) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="footer_btn_link" id="footer_btn_link" class="form-control @error('footer_btn_link') is-invalid @enderror"
                                    placeholder="Enter button link" value="{{ old('footer_btn_link', $blog->footer_btn_link) }}">

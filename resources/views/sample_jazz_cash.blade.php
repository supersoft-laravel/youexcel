        ...
        <div class="container mt-5" id="outcome">
            <div class="row">
                <div class="col-lg-8 mt-5 mb-5">
                    ...
                    <p>Financial Modeling & Analysis training is a competency based course adopting structured approach
                        to
                            ...
                            <div class="col-lg-6">
                                <ul style="display: flex;">
                                    <span><i class="fas fa-check" aria-hidden="true"></i></span>&emsp; <p
                                        style="font-size: 17px;"> Construct Dynamic Financial Models</p>
                                </ul>
                            </div>
                            <div class="col-lg-6" id="course-outline">
                                <ul style="display: flex;">
                                    <span><i class="fas fa-check" aria-hidden="true"></i></span>&emsp; <p
                                        style="font-size: 17px;"> Create visually effective Dashboards through Power
                                        Query</p>
                                </ul>
                            </div>
                            <div class="col-lg-6">
                                <ul style="display: flex;">
                                    <span><i class="fas fa-check" aria-hidden="true"></i></span>&emsp; <p
                                        style="font-size: 17px;"> Analyze Dashboards to gain business insights</p>
                                </ul>
                            </div>
                            <div class="col-lg-6">
                                <ul style="display: flex;">
                                    <span><i class="fas fa-check" aria-hidden="true"></i></span>&emsp; <p
                                        style="font-size: 17px;"> Develop Effective Business Presentation Skills</p>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <!-- <table class="table table-bordered">
                        <tbody>
                            <tr> -->
                    <td>Completed or studying Diploma/Degree holders in Commerce/Business Studies</td>
                    <!-- </tr>
                </tbody>
            </table> -->
    ...
    <section>
        <div class="container mt-5 mb-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="col-lg-12 text-center">
{{--                        <a class="btn btn-lmslogin mb-4 btn-lg" href="Registration-Form/Financial-Modeling-and-Analysis">Click here to Register--}}
{{--                            Online </a>--}}
{{--                        --}}
                        <button class="btn btn-success pay_now">
                            Pay Fee Online
                        </button>
                    </div>
                    <!-- button hover  -->

@extends('website.app', ['title' => 'Data Analytics Using Python with Azure DevOps'])
...
@section('content')
    ...
    <section class="space-top space-extra-bottom section-header">
        ...
        <div class="container section-content text-center">
            <div class="section-title">
                <h2>
                    Empower Insights, Automate Workflows: Begin Your Data Analytics Journey with
                    Python and Azure DevOps Today!
                </h2>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row flex-row-reverse">
                    ...
                    <div class="course-meta-box wow fadeInUp ">
                        ...
                        @else
                            <a href="{{ $pdf }}" class="vs-btn"> Download Brochure
                                Now</a><br /><br />
                        @endif
                        <a href="https://youexceltraining.com/enquiry-form/data-analytics-using-python-with-azure-devOps"
                ...
                <div class="col-lg-8">
                    ...
                    <h2 class="course-title animate__animated animate__bounceInDown">Data Analytics Using Python with Azure
                        DevOps
                    </h2>
                    ...
                    <div class="mb-3">
                        <img src="https://youexceltraining.com/img/Yourexcel-img/python-azure-1.png" />
                    </div>
                    <div class="mb-2 mt-2">
                    ...
                    <p class="wow fadeInDown pb-3">The Data Analytics Using Python with Azure DevOps program is a
                        comprehensive 8-week course designed to equip learners with practical skills in Python-based data
                        analysis and DevOps integration. With hands-on assignments and a real-world capstone project,
                        participants will gain proficiency in data cleaning, transformation, visualization, and deploying
                        data workflows using Azure DevOps. Whether you are a beginner or an analyst looking to enhance
                        automation and collaboration, this course provides the tools and knowledge to thrive in data-driven
                        roles.</p>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header d-flex" id="headingOne">
                                <button class="accordion-button justify-content-between" type="button"
                                    ...
                                    Introduction to Python & Data Analytics Tools
                                ...
                                <div class="accordion-body wow fadeInUp">
                                    <div class="syllabus-list">
                                        <div class="syllabus-content">
                                            <li class="syllabustext">Python setup (Anaconda, Jupyter)</li>
                                            <li class="syllabustext">Variables, Loops, Functions</li>
                                            <li class="syllabustext">NumPy</li>
                                            <li class="syllabustext">Pandas</li>
                                            <li class="syllabustext">Assignment 1: Basic DataOps in Python</li>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo">
                                <div class="accordion-body wow fadeInUp">
                                    <div class="syllabus-list">
                                        <div class="syllabus-content">
                                            <li class="syllabustext">Missing values</li>
                                            <li class="syllabustext">Normalization</li>
                                            <li class="syllabustext">Encoding</li>
                                            <li class="syllabustext">Date handling</li>
                                            <li class="syllabustext">Outliers</li>
                                            <li class="syllabustext">Assignment 2: Clean a raw dataset</li>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header d-flex" id="headingThree">
                                <button class="accordion-button justify-content-between" type="button"
                                    ...
                                    Feature Engineering & Large Dataset Handling
                                    <i class="fas fa-angle-down"></i>
                                </button>
                            </div>
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree">
                                <div class="accordion-body wow fadeInUp">
                                    <div class="syllabus-list">
                                        <div class="syllabus-content">
                                            <li class="syllabustext">Feature scaling</li>
                                            <li class="syllabustext">Polynomial features</li>
                                            <li class="syllabustext">Memory optimization in Pandas</li>
                                            <li class="syllabustext">Assignment 3: Feature engineering</li>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour">
                                <div class="accordion-body wow fadeInUp">
                                    <div class="syllabus-list">
                                        <div class="syllabus-content">
                                            <li class="syllabustext">Matplotlib</li>
                                            <li class="syllabustext">Seaborn</li>
                                            <li class="syllabustext">Plot customization</li>
                                            <li class="syllabustext">Heatmaps</li>
                                            <li class="syllabustext">Correlation plots</li>
                                            <li class="syllabustext">Assignment 4: Visual analysis</li>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header d-flex" id="headingFive">
                                <button class="accordion-button justify-content-between" type="button"
                                    ...
                                    Interactive Visuals & Dashboarding
                                    <i class="fas fa-angle-down"></i>
                                </button>
                            </div>
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive">
                                <div class="accordion-body wow fadeInUp">
                                    <div class="syllabus-list">
                                        <div class="syllabus-content">
                                            <li class="syllabustext">Plotly</li>
                                            <li class="syllabustext">Dash/Streamlit framework</li>
                                            <li class="syllabustext">Dashboard projects</li>
                                            <li class="syllabustext">Assignment 5: Dash dashboard</li>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header d-flex" id="headingSix">
                                <button class="accordion-button justify-content-between" type="button"
                                    ...
                                    Azure DevOps Essentials for Analysts
                                    <i class="fas fa-angle-down"></i>
                                </button>
                            </div>
                            <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix">
                                <div class="accordion-body wow fadeInUp">
                                    <div class="syllabus-list">
                                        <div class="syllabus-content">
                                            <li class="syllabustext">Git basics</li>
                                            <li class="syllabustext">Azure Boards</li>
                                            <li class="syllabustext">Repos</li>
                                            <li class="syllabustext">Pipelines</li>
                                            <li class="syllabustext">DevOps lifecycle overview</li>
                                            <li class="syllabustext">Assignment 6: Setup DevOps workflow</li>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header d-flex" id="headingSeven">
                                <button class="accordion-button justify-content-between" type="button"
                                    ...
                                    Integrating Azure DevOps in Data Projects
                                    <i class="fas fa-angle-down"></i>
                                </button>
                            </div>
                            <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven">
                                <div class="accordion-body wow fadeInUp">
                                    <div class="syllabus-list">
                                        <div class="syllabus-content">
                                            <li class="syllabustext">YAML pipelines for EDA projects</li>
                                            <li class="syllabustext">Data versioning</li>
                                            <li class="syllabustext">Shared repos</li>
                                            <li class="syllabustext">Automation</li>
                                            <li class="syllabustext">Assignment 7: Git + CI for Python</li>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight">
                                <div class="accordion-body wow fadeInUp">
                                    <div class="syllabus-list">
                                        <div class="syllabus-content">
                                            <li class="syllabustext">Full E2E project using Python + DevOps (cleaning →
                                                visualization → deployment)</li>
                                            <li class="syllabustext">Final Submission & Presentation</li>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row gy-3">
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                        ...
                        <p class="mb-0" style="font-size: 15px; color: #333;">
                            Use Python and essential libraries (NumPy, Pandas, Matplotlib,
                            Seaborn, Plotly, and Streamlit) for data analytics.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                        ...
                        <p class="mb-0" style="font-size: 15px; color: #333;">
                            Perform data cleaning, preprocessing, and feature engineering to
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                        ...
                        <p class="mb-0" style="font-size: 15px; color: #333;">
                            Conduct exploratory data analysis (EDA) and generate meaningful
                            visualizations.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                        ...
                        <p class="mb-0" style="font-size: 15px; color: #333;">
                            Build interactive dashboards using the Streamlit framework.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                        ...
                        <p class="mb-0" style="font-size: 15px; color: #333;">
                            Understand the fundamentals of Azure DevOps and implement CI/CD
                            pipelines tailored for data science workflows.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                        ...
                        <p class="mb-0" style="font-size: 15px; color: #333;">
                            Use Git, Azure Boards, and Pipelines for collaborative project
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                        ...
                        <i class="fas fa-share-square text-info fs-4 me-3 mt-1"></i>
                        <p class="mb-0" style="font-size: 15px; color: #333;">
                            Apply version control and automation strategies within analytics
                            projects.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                        ...
                        <i class="fas fa-share-square text-info fs-4 me-3 mt-1"></i>
                        <p class="mb-0" style="font-size: 15px; color: #333;">
                            Complete an end-to-end analytics project with real-world data,
                            demonstrating skills in data transformation, visualization, and DevOps integration.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="card h-100 text-center shadow-sm border-0"
                        ...
                        <h6 style="font-weight: 600; color: #212529;">Data cleaning & transformation on a real-world
                            dataset to ensure high-quality, usable data.</h6>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="card h-100 text-center shadow-sm border-0"
                        ...
                        <img src="https://youexceltraining.com/img/icon/training-icon-1-2.svg" alt="icon"
                            style="width: 60px; margin-bottom: 20px;">
                        <h6 style="font-weight: 600; color: #212529;">Perform exploratory and statistical analysis to
                            uncover trends, patterns, and insights.</h6>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="card h-100 text-center shadow-sm border-0"
                        ...
                        <img src="https://youexceltraining.com/img/icon/training-icon-1-3.svg" alt="icon"
                            style="width: 60px; margin-bottom: 20px;">
                        <h6 style="font-weight: 600; color: #212529;">Build dashboards and reports to visually present
                            findings using Streamlit or visualization tools.</h6>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="card h-100 text-center shadow-sm border-0"
                        ...
                        <img src="https://youexceltraining.com/img/icon/training-icon-1-4.svg" alt="icon"
                            style="width: 60px; margin-bottom: 20px;">
                        <h6 style="font-weight: 600; color: #212529;">Implement CI/CD pipelines for analytics workflows
                            using Azure DevOps.</h6>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 border-0 shadow-sm text-start p-3"
                        ...
                        <p style="font-size:14px; color:#333; margin:0;">
                            Students and professionals interested in data analytics, beginners in Python and data science,
                            analysts looking to automate and collaborate using DevOps pipelines.
                        </p>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 col-md-7 mb-4 mb-md-0">
                    <div class="p-4 rounded shadow-sm bg-white">
                        ...
                        <p class="mb-4" style="font-size: 15px; color: #555; line-height: 1.7;">
                            <b>M. Rafay Shaikh's</b> technical expertise includes Data Science, Power BI, PySpark, Python,
                        ...
                        <p class="mb-4" style="font-size: 15px; color: #555; line-height: 1.7;">
                            Previously, Rafay was an IT Support Engineer at Dumb TV, managing websites, domains, servers,
                            and social media.
                        </p>
                        ...
                        <ul class="list-unstyled mb-0">
                            <li><i class="fas fa-check-circle text-success me-2"></i>Microsoft Power BI Data Analyst PL300
                                Certification 2025</li>
                ...
                <div class="col-lg-4 col-md-5 text-center">
                    <div class="position-relative d-inline-block">
                        <img src="{{ asset('img/trainer/new/M-Rafay-Shaikh.png') }}" alt="Trainer - M. Rafay Shaikh"
            ...
            <div class="row gy-3">
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-white rounded shadow-sm h-100"
                        ...
                        <p class="mb-0" style="font-size: 15px; color: #444;">
                            Lifetime video recorded session with personalized Learning Management System (LMS) access login
                            ID for months
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-white rounded shadow-sm h-100"
                        ...
                        <p class="mb-0" style="font-size: 15px; color: #444;">
                            Fully equipped training center venue for on-campus trainings readily available with laptops,
    ...
    <section class="py-5 m-3 cta-style2">
        <div class="container text-center">
            ...
            <!-- CTA Button -->
            <a href="../Registration-Form/data-analytics-using-python-with-azure-devOps" class="btn btn-lg fw-bold"

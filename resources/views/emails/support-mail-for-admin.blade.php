        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <p>New Support Form Submission</p>
                    <p>
                        ...
                        <div class="info"><strong>Course:</strong> {{ $email_data['coursesintrested'] }}</div>
                        <div class="info"><strong>Batch No:</strong> {{ $email_data['batchno'] }}</div>

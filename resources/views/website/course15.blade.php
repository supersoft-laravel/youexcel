        ...
        <div class="container">
            <div class="row flex-row-reverse">
                ...
                <div class="col-lg-8">
                    ...
                    <p class="wow fadeInDown pb-3">Financial Modeling and Analysis training is a competency-based course
                        adopting structured approach to translating business insights through numerous data visualization
                        tools using dynamic Financial Dashboards. It also fulfils the need of Business Presentation skills
                        in perspective of delivering an impactful
                                ...
                                <div class="accordion-body wow fadeInDown">
                                    <div class="syllabus-list">
                                        ...
                                        <div class="syllabus-content">
                                            ...
                                            <li class="syllabustext">Sensitivity Analysis of Share Price and terminal value
                                            </li>
            ...
            <div class="row gy-3">
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                        ...
                        <p class="mb-0" style="font-size: 15px; color: #333;">
                            Construct Dynamic Financial Models
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                        ...
                        <p class="mb-0" style="font-size: 15px; color: #333;">
                            Create visually effective Dashboards through Power Query
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                        ...
                        <p class="mb-0" style="font-size: 15px; color: #333;">
                            Analyze Dashboards to gain business insights
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card h-100 text-center shadow-sm border-0"
                        ...
                        <h6 style="font-weight: 600; color: #212529;">Better understanding of business by building solid
                            foundation on modeling techniques</h6>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card h-100 text-center shadow-sm border-0"
                        ...
                        <img src="https://youexceltraining.com/img/icon/training-icon-1-2.svg" alt="icon"
                            style="width: 60px; margin-bottom: 20px;">
                        <h6 style="font-weight: 600; color: #212529;">Minimizing through sensitivity analysis to assess the
                            impact of changing variables</h6>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card h-100 text-center shadow-sm border-0"
                        ...
                        <img src="https://youexceltraining.com/img/icon/training-icon-1-3.svg" alt="icon"
                            style="width: 60px; margin-bottom: 20px;">
                        <h6 style="font-weight: 600; color: #212529;">Creating financial forecasts through effective power
                            dashboards</h6>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="card h-100 text-center shadow-sm border-0"
                        ...
                        <img src="https://youexceltraining.com/img/icon/training-icon-1-4.svg" alt="icon"
                            style="width: 60px; margin-bottom: 20px;">
                        <h6 style="font-weight: 600; color: #212529;">Establishing dynamic connections between data sets to
                            ensure streamlined data updates and
                            analysis through dynamic connections</h6>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="card h-100 text-center shadow-sm border-0"
                        ...
                        <img src="https://youexceltraining.com/img/icon/training-icon-1-5.svg" alt="icon"
                            style="width: 60px; margin-bottom: 20px;">
                        <h6 style="font-weight: 600; color: #212529;">Business valuation of real-world financial scenarios
                        </h6>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 border-0 shadow-sm text-start p-3"
                        ...
                        <p style="font-size:14px; color:#333; margin:0;">
                            Accounting, Finance Professionals, Analysts, and Students.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 border-0 shadow-sm text-start p-3"
                        ...
                        <p style="font-size:14px; color:#333; margin:0;">Beginner to Intermediate</p>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 col-md-7 mb-4 mb-md-0">
                    <div class="p-4 rounded shadow-sm bg-white">
                        ...
                        <p class="mb-4" style="font-size: 15px; color: #555; line-height: 1.7;">
                            ...
                            training.
                            He is passionate to share his practical experience of over 19 years of working in the industry
                            with his students to help learn from real-life case studies.
                        </p>
                ...
                <div class="col-lg-4 col-md-5 text-center">
                    <div class="position-relative d-inline-block">
                        <img src="{{ asset('img/trainer/tanweer.png') }}" alt="Trainer - Tanweer Bukhsh"

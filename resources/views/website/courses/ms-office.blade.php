                ...
                <div class="col-lg-8">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="overview">
                            ...
                            <p class="mb-2">
                                Simplify your day to day tasks at work and academics to improve
                                productivity with Microsoft Office professional training program. This Microsoft Office
                                course
                                focuses on the most important and most popular features of Microsoft Office, providing you
                                with
                                skills to be productive and efficient in Microsoft Word, Microsoft Excel, Microsoft
                                PowerPoint, and
                                Microsoft Outlook. You’ll also learn to link data between these applications. The program is
                                100%
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                                            ...
                                            <p class="mb-0" style="font-size: 15px; color: #333;">
                                                Effectively apply MS PowerPoint to create presentations at a professional
                                                level
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                                            ...
                                            <p class="mb-0" style="font-size: 15px; color: #333;">
                                                Apply AI integration techniques in MS Office tools and Chat GPT to enhance
                                                productivity
                                            </p>
                                        </div>
                                    </div>
                                            ...
                                            <div class="trainer-card">
                                                ...
                                                <div class="profile-header row">
                                                    ...
                                                    <div class="trainer-image-wrapper col-md-4">
                                                        <img src="{{ asset('img/trainer/new2/Farhan-Shahid-Qazi-MS-Office-Management.png') }}"
                                                            alt="Trainer Image">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="card h-100 border-0 shadow-sm text-start p-3"
                                                ...
                                                <p style="font-size:14px; color:#333; margin:0;">
                                                    ...
                                                    Scientists, Project Managers, Operations and Logistics Manager, HR
                                                    Professionals, IT
                                                    Professionals,
                                                    Students
                                                </p>

                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <label for="">Course <span style="color: red;">*</span></label>
                                            <select class="form-control" name="course_id" id="coursesintrested" data-live-search="true" {{ isset($course) ? 'readonly' : ''}}>
                                                @foreach ($courses as $cour)
                                                    <option value="{{ $cour->id }}" {{ isset($course) && $course->id == $cour->id ? 'selected' : ''}}>{{ $cour->coursename }}</option>
                                                @endforeach
                                    ...
                                    <div class="col-lg-6">
                                        <label for="city">City 
                                        <!--<small>(Only Karachi Residents must apply)</small>-->
                                        <span style="color: red;">*</span></label>
                                        <input class="form-control" name="city" id="city" placeholder="Enter Your City " type="text">

			...
			<div class="col-lg-10 ">
				<div class="card mb-5">
					...
					<div class="card-body" style="overflow-x: hidden;">
						...
						<form action="{{ route('store.registration-form-project') }}" method="POST">
							@csrf
							<div class="row">
								...
								<div class="col-lg-6">
									<label for="" style="font-weight: bold;">Father Name <span style="color: red;">*</span></label>
									<input name="father_name" class="form-control" placeholder="Your Father Name" required=""
										type="text">
								</div>
								<div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="cnic" style="font-weight: bold;">CNIC/National ID No: <span
								...
								<div class="col-lg-5">
									<label for="" style="font-weight: bold;">WhatsApp No (Mention again if Contact no is same) <span style="color: red;">*</span></label>
                                ...
                                <div class="col-lg-4">
									<label for="" style="font-weight: bold;">Present Address <span style="color: red;">*</span></label>
									<input name="present_address" class="form-control" placeholder="Enter Complete Present Address" required=""
										type="text">
								</div>
                                <div class="col-lg-4">
									<label for="" style="font-weight: bold;">Domicile <span style="color: red;">*</span></label>
									<input name="domicile" class="form-control" placeholder="Enter Domicile" required=""
										type="text">
								</div>
                                <div class="col-lg-4">
									<label for="" style="font-weight: bold;">Present District <span style="color: red;">*</span></label>
									<input name="present_district" placeholder="Your present district" class="form-control" required=""
										type="text">
								</div>

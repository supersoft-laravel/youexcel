                ...
                <div class="col-lg-8">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="overview">
                            ...
                            <p class="mb-2">
                                YouExcel is bringing an innovative training that aims to equip participants with the
                                necessary
                                skills and knowledge to establish and manage an online store effectively. The program
                                focuses on
                                practical, hands-on training that covers all aspects of e-commerce, from setting up the
                                store to
                                running campaigns online through Digital Marketing, Search Engine Marketing and
                                Optimization.
                            </p>
                        </div>
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                                            ...
                                            <p class="mb-0" style="font-size: 15px; color: #333;">
                                                Set up online stores on Shopify, Daraz, or custom your own platform by
                                                applying strategies of E-Commerce
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                                            ...
                                            <p class="mb-0" style="font-size: 15px; color: #333;">
                                                Create and manage campaigns on Facebook, Instagram, TikTok, and Pinterest by
                                                applying strategies of Digital Marketing
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                                            ...
                                            <p class="mb-0" style="font-size: 15px; color: #333;">
                                                Develop strategies for Search Engine Marketing (SEM) and paid advertising
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-start p-3 bg-light rounded shadow-sm h-100"
                                            ...
                                            <p class="mb-0" style="font-size: 15px; color: #333;">
                                                Monitor and evaluate online store performance to increase income growth
                                                opportunities
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-12 mb-4">
                                            <div class="trainer-card">
                                                ...
                                                <div class="profile-header row">
                                                    <p class="col-md-8">
                                                        <b>Syed Asif Ashraf</b> is a learning and development and Digital
                                                        Marketing Professional with an
                                                        overall experience of 20 years. His education consists of an MBA in
                                                        Marketing and an M.A. in
                                                        Mass Communication. Asif is also a Google certified digital
                                                        marketing professional. He has
                                                        previously worked in renowned companies such as BOL Network, Polaris
                                                        Consultants, Federal Urdu
                                                        University, The Access to Future Foundation (TAF), Click 5 institute
                                                        amongst others and has also
                                                        been lead effective training in NAVTTC, Govt. Of Pakistan training
                                                        projects.
                                                    </p>
                                                    <div class="trainer-image-wrapper col-md-4">
                                                        <img src="{{ asset('img/trainer/new2/Syed-Asif-Ashraf-E-Dukaan-Specialist.png') }}"
                                                            alt="Trainer Image">
                                                ...
                                                <ul class="list-unstyled mb-0">
                                                    <li><i class="fas fa-check-circle text-success me-2"></i>Digital Marketing and E-Commerce Certification from Google</li>
                                                    <li><i class="fas fa-check-circle text-success me-2"></i>Certification in E-Commerce from Digiskills Pakistan</li>
                                                    <li><i class="fas fa-check-circle text-success me-2"></i>Cloud Computing Certification from PIAIC</li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="card h-100 border-0 shadow-sm text-start p-3"
                                                ...
                                                <p style="font-size:14px; color:#333; margin:0;">
                                                    Anyone who wants to earn online, students, housewives, business

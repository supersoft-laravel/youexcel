                        ...
                        <div class="card-body ">
                            ...
                            <form action="{{ route('Registration-Form') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <!--                    required>-->
                                    <!--                    <option value="" disabled selected>Please select a programme</option>-->
                                    ...
                                    <!--</div>-->
                                    <div class="col-lg-12 mt-2">
                                        <h5>Please choose Programme: <span class="text-danger">*</span></h5>
                                        ...
                                        <select 
                                            ...
                                            required
                                        >
                                            <option value="" disabled {{ !isset($course) ? 'selected' : '' }}>
                                            ...
                                            @foreach ($courses as $cour)
                                                <option 
                                                    value="{{ $cour->slug }}"
                                                    {{ (isset($course) && $course == $cour->slug) ? 'selected' : '' }}
                                                >
                                                    {{ $cour->coursename }}
                                                </option>
                                            @endforeach
                                        ...
                                        <!-- OTHER FIELD -->
                                        <div class="mt-3 d-none" id="otherCourseDiv">
...
">
    ...
    <script>
        document.getElementById("slug").addEventListener("change", function () {
            ...
            let otherField = document.getElementById("otherCourseDiv");

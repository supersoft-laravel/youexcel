                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror"
                                placeholder="Enter slug" value="{{ old('slug', $trainer->slug) }}" required>
                            @error('slug') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="experience" min="0" class="form-control @error('experience') is-invalid @enderror"
                                placeholder="Enter experience" value="{{ old('experience', $trainer->experience) }}" required>
                            @error('experience') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="rating" min="0" step="0.1" max="5" class="form-control @error('rating') is-invalid @enderror"
                                placeholder="Enter rating" value="{{ old('rating', $trainer->rating) }}">
                            @error('rating') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            @enderror
                            @if($trainer->picture)
                                <a class="btn btn-link" href="{{ asset($trainer->picture) }}" target="_blank">View</a>
                            @endif
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror"
                                placeholder="Enter phone" value="{{ old('phone', $trainer->phone) }}">
                            @error('phone') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="linkedin" class="form-control @error('linkedin') is-invalid @enderror"
                                placeholder="Enter linkedin url" value="{{ old('linkedin', $trainer->linkedin) }}">
                            @error('linkedin') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="facebook" class="form-control @error('facebook') is-invalid @enderror"
                                placeholder="Enter facebook url" value="{{ old('facebook', $trainer->facebook) }}">
                            @error('facebook') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="instagram" class="form-control @error('instagram') is-invalid @enderror"
                                placeholder="Enter instagram url" value="{{ old('instagram', $trainer->instagram) }}">
                            @error('instagram') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="bio" class="form-control @error('bio') is-invalid @enderror"
                                placeholder="Enter bio" value="{{ old('bio', $trainer->bio) }}" required>
                            @error('bio') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="description" rows="5"
                                ...
                                placeholder="Enter description">{{ old('description', $trainer->description) }}</textarea>
                            @error('description') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                                ...
                                @if(!empty($certifications))
                                    @foreach($certifications as $certification)
                                        <div class="input-group mb-2 cert-item">
                                            <input type="text" name="certifications[]" class="form-control" value="{{ $certification }}" placeholder="Enter certification">

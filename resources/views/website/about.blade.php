        ...
        <div class="row">
            <div class="col-md-6">
                <section class="space-top space-bottom">
                    <div class="container">
                        <div class="cta-style2" style="height: 350px;">
                            <div class="row align-items-center">
                                <div class="col-lg-12">
                                    <div class="cta-content" style="height: 100%;">
                                        <div>
                                            <h2 class="cta-title h1">Step Into Excellence by Empowering yourself with skills</h2>
                                        </div>
                                        <a href="{{ route('download.company_profile') }}" style="white-space: nowrap; margin-top: 106px;" class="vs-btn style2 position-center">
                        ...
                        <div class="cta-style2" style="height: 350px;">
                            <div class="row align-items-center">
                                <div class="col-lg-12">
                                    <div class="cta-content" style="height: 100%;">
                                        <div>
                                            <!--<p class="cta-text">Certified and industry experienced Trainers</p>-->
                                            <h2 class="cta-title h1">Certified, Experienced Trainers — Dedicated to Helping You Excel at Every Level.</h2>
                                        </div>
                                        <a href="{{ url('/trainer-profiles') }}" style="white-space: nowrap; margin-top: 100px;" class="vs-btn style2 position-center">
                                            <i class="far fa-angle-right"></i>View Trainer Profiles 
                                        </a>
                                    </div>
                                </div>
                            </div>

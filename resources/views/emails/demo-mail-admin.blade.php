        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <p>New Demo Confirmation Form Submission</p>
                    <p>
                        ...
                        <div class="info"><strong>Demo Course:</strong> {{ $email_data['demo'] }}</div>
                        <div class="info"><strong>Mode of Attend:</strong> {{ $email_data['mode_of_attend'] }}</div>
                    </p>

                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="coursename" id="coursename" class="form-control @error('coursename') is-invalid @enderror"
                                placeholder="Enter course name" value="{{ old('coursename') }}" required>
                            @error('coursename') 
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="tagline" id="tagline" class="form-control @error('tagline') is-invalid @enderror"
                                placeholder="Enter tagline" value="{{ old('tagline') }}" required>
                            @error('tagline') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-6">
                            <label for="difficulty">Difficulty Level</label><span class="text-danger">*</span>
                            <input type="text" name="difficulty" class="form-control @error('difficulty') is-invalid @enderror"
                                placeholder="Enter difficulty" value="{{ old('difficulty') }}" required>
                            @error('difficulty') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-6">
                            <label for="rating">Rating <small>(rate from 1 to 5)</small></label><span class="text-danger">*</span>
                        ...
                        <div class="form-group col-md-6">
                            <label for="duration">Duration <small>(write in hours)</small></label><span class="text-danger">*</span>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="sessions" min="0" class="form-control @error('sessions') is-invalid @enderror"
                                placeholder="Enter sessions" value="{{ old('sessions') }}">
                            @error('sessions') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-6">
                            <label for="lump_sum_fee">Lump Sum Fee</label><span class="text-danger">*</span>
                            <input type="text" name="lump_sum_fee" class="form-control @error('lump_sum_fee') is-invalid @enderror"
                                placeholder="Enter fee" value="{{ old('lump_sum_fee') }}" required>
                            @error('lump_sum_fee') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-6">
                            <label for="zoho_id">Zoho Id</label><span class="text-danger">*</span>
                            <input type="text" name="zoho_id" class="form-control @error('zoho_id') is-invalid @enderror"
                                placeholder="Enter zoho id" value="{{ old('zoho_id') }}">
                            @error('zoho_id') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="overview" rows="5"
                                ...
                                placeholder="Enter overview">{{ old('overview') }}</textarea>
                            @error('overview') 
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="recommendation" id="recommendation" class="form-control @error('recommendation') is-invalid @enderror"
                                placeholder="Enter recommendation" value="{{ old('recommendation') }}" required>

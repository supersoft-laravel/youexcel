...
<section class="pt-5 mt-5">
    <div class="container studentPolicyContainer">
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-10 ">
                        ...
                        <h2>YouExcel’s Student Policy & Procedures 2022</h2>
                    </div>
      <div class="col-lg-2 ">
                        ...
                        <div id="accordion">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">
                                        <a class="btn btn-link collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse1">
                                                1. Foreword
                                        </a>
                                    </h5>
                                </div>
